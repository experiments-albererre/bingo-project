...
var human = document.querySelector(".playerContainer");
var machine = document.querySelector(".cpuContainer"); // init variables
...
var gameNumbers = [];
var humanCounter = 0;
var machineCounter = 0; //Functions

var finishGame = function finishGame(_msg) {
  var bol = swal({
    title: _msg,
...
var randomNumber = function randomNumber(_event) {
  // check if this is the first time you push button
  started == false ? startGame() : true; // use array to avoid repeat numbers played

  var number = gameNumbers[gameNumbers.length - 1];
  gameNumbers.pop();
...
var crossNumber = function crossNumber(_number) {
  if (document.querySelector(".number.n".concat(_number))) {
    var num = document.querySelectorAll(".number.n".concat(_number));
    ...
    document.querySelector(".playerContainer .number.n".concat(_number)) ? humanCounter = humanCounter + 1 : true;
    console.log(humanCounter);
    document.querySelector(".cpuContainer .number.n".concat(_number)) ? machineCounter = machineCounter + 1 : true;
...
var generateCards = function generateCards(_array) {
  ...
  var shuffledRange = _.shuffle(range);
...
button.addEventListener("click", function (event) {
  return randomNumber(event);
}); //button.onclick = () => randomNumber();
},{"lodash":"../node_modules/lodash/lodash.js","vanilla-tilt":"../node_modules/vanilla-tilt/lib/vanilla-tilt.js","sweetalert2":"../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42045" + '/');
